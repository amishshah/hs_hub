...
import { HardwareSSEService } from "./hardwareSSEService";
...
export class HardwareService implements HardwareServiceInterface {
  ...
  private sseService: HardwareSSEService;
